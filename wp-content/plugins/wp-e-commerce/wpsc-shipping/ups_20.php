...
*/
    ...
    function getQuote(){
        ...
        if(isset($_POST['zipcode']) && ($_POST['zipcode'] != "Insira o CEP" && $_POST['zipcode'] != "YOURZIPCODE")) {
          $args['dest_pcode'] = $_POST['zipcode'];
          $_SESSION['wpsc_zipcode'] = $_POST['zipcode'];
        } else if(isset($_SESSION['wpsc_zipcode']) && ($_POST['zipcode'] != "Insira o CEP" && $_POST['zipcode'] != "YOURZIPCODE")) {
